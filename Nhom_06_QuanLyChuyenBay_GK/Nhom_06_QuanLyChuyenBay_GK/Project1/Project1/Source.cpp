...
public:
	...
	// Ham hien thi danh sach cac khach hang theo form booking / refund
...
public:
	...
	Flight(string _flightCode, string _planeSign, string _departureDay, string _airportLocation, int _status,int seats) {
		flightCode = _flightCode;
	...
	void outputFlight(int x) {
		...
		// danh sách vé trong list of flights
	...
	// Ham hien thi danh sach chuyen bay chua hoan tat (refund)
...
tryagain: // Tao moc de quay lai
	...
	case 3: {
		...
		case 3: {
			...
			//gotoXY(53, 5); cout << "THE FUNTION IS MAINTAINED";
			gotoXY(37, 5); cout << "Enter the flight code";
			gotoXY(64, 5); cout << ":";
			string flightCode;
			int x;
		...
		case 4: {
			...
			cout << setw(49) << right << "||";
			setColor(0, 10);
			cout << setw(24) << right << "       A D D F L I G H T S         ";
			setColor(0, 14);
			cout << "||" << endl;
			cout << setw(85) << right << "--------------------------------------" << endl;
			tryagain10:
			...
			gotoXY(64, 5); cout << ":";
			string flightAdd;
			setColor(0, 15); gotoXY(74, 5); getline(cin, flightAdd);
			if (flightAdd == "" || flightAdd == " ") {
				setColor(0, 12); gotoXY(48, 25); cout << "DO NOT LEAVE BLANKS OR ENTER SPACES!";
				goto tryagain10;
			}
		tryagain11:
			setColor(0, 14);
			gotoXY(37, 6); cout << "Enter the plane code";
			gotoXY(64, 6); cout << ":";
			string planeAdd;
			setColor(0, 15); gotoXY(74, 6); getline(cin, planeAdd);
			if (planeAdd == "" || planeAdd == " ") {
				setColor(0, 12); gotoXY(48, 25); cout << "DO NOT LEAVE BLANKS OR ENTER SPACES!";
				goto tryagain11;
			}
			bool checking = false;
			for (list<Plane>::iterator i = plane.begin(); i != plane.end(); i++) {
				if (i->getAircrafNumber() == planeAdd) {
					checking = true;
				}
			}
			if(checking == false){
					setColor(0, 12); gotoXY(60, 24); cout << "Not Found";
					setColor(0, 12); gotoXY(74, 6); cout << "                                         ";
					gotoXY(60, 24);
					waiting(2500);
					setColor(0, 12); gotoXY(60, 24); cout << "                                         ";
					goto tryagain11;
				}
			...
			if (checking == true) {
				setColor(0, 14);
				gotoXY(37, 7); cout << "Enter the flight date";
				gotoXY(64, 7); cout << ":";
				string flightDate;
				setColor(0, 15); gotoXY(74, 7); getline(cin, flightDate);
				if (flightDate == "" || flightDate == " ") {
					setColor(0, 12); gotoXY(48, 25); cout << "DO NOT LEAVE BLANKS OR ENTER SPACES!";
					goto tryagain12;
				}
				tryagain13:
				setColor(0, 14);
				gotoXY(37, 8); cout << "Enter the Ariport";
				gotoXY(64, 8); cout << ":";
				string flightDestination;
				setColor(0, 15); gotoXY(74, 8); getline(cin, flightDestination);
				if (flightDestination == "" || flightDestination == " ") {
					setColor(0, 12); gotoXY(48, 25); cout << "DO NOT LEAVE BLANKS OR ENTER SPACES!";
					goto tryagain13;
				}
				tryagain14:
				setColor(0, 14);
				gotoXY(37, 9); cout << "Enter the flight seats";
				gotoXY(64, 9); cout << ":";
				int seats;
				setColor(0, 15); gotoXY(74, 9); cin >> seats;
				if (seats == 0) {
					setColor(0, 12); gotoXY(48, 25); cout << "PLEASE ENTER THE NUMBER OF SEATS FOR THE FLIGHT";
					goto tryagain14;
				}
				Flight newFlight(flightAdd, planeAdd, flightDate, flightDestination, 1,seats);
				flight.push_back(newFlight);
				updateFlight(flight);
			}
			
			goto tryagain1;
			break;
			//string _flightCode, string _planeSign, string _departureDay, string _airportLocation, int _status
		}
		// Tro ve main menu
		case 5:
			goto tryagain;
...
tryagain1:
	...
	if (flight.size() == 0) {
		...
		for (unsigned int i = 0; i < flight.size(); i++) {
			...
			advance(it,i);
			if (it->getStatus() != 3 && it->getStatus() != 0) {
				if (n > 2) {
					n = 0; x++;
				}
				if (n == 0) {
